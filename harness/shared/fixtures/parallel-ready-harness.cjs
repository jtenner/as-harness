...
const NODE_METADATA_BY_INDEX = new Map([
	...
	["0.0", { nodeId: 5, parentNodeId: 1, declarationOrder: 4 }],
	["1.0", { nodeId: 6, parentNodeId: 2, declarationOrder: 5 }],
	["2.0", { nodeId: 7, parentNodeId: 3, declarationOrder: 6 }],
	["3.0", { nodeId: 8, parentNodeId: 4, declarationOrder: 7 }],
]);
	...
	discover(nodeIndex) {
		switch (Array.isArray(nodeIndex) ? nodeIndex.join(".") : "<invalid>") {
			case "":
				...
				this.#emitNode([2], NODE_KIND_SUITE, "branch-c");
