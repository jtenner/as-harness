...
export function runNotDeepEqualPass(): void {
	notDeepEqual<Array<i32>>([1, 2], [1, 3]);
}
...
export function runDeepEqualFailWithMessage(): void {
	deepEqual<i32>(11, 12, "deepEqual mismatch");
}
...
export function runEqualFailWithMessage(): void {
	equal<i32>(11, 12, "equal mismatch");
}
...
export function runNotEqualFailWithMessage(): void {
	notEqual<i32>(11, 11, "notEqual mismatch");
}
...
export function runNotDeepEqualFailWithMessage(): void {
	notDeepEqual<Array<i32>>([1, 2], [1, 2], "notDeepEqual mismatch");
}
