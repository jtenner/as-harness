...
const dependencyPrereq =
	test("dependency prereq", (_context: TestContext): void => {});

test("dependency dependent", (_context: TestContext): void => {}).dependsOn(
	dependencyPrereq,
);

const dependencyFailingPrereq =
	test("dependency failing prereq", (context: TestContext): void => {
		context.assert.strictEqual<i32>(
			51,
			52,
			"dependency failing prereq mismatch",
		);
	});

test("dependency blocked dependent", (_context: TestContext): void => {}).dependsOn(
	dependencyFailingPrereq,
);
...
test("dependency satisfied dependent", (_context: TestContext): void => {}).dependsOn(
	dependencyExpectedFailurePrereq,
);

const dependencySkippedPrereq =
	test.skip("dependency skipped prereq", (_context: TestContext): void => {});

test("dependency skipped dependent", (_context: TestContext): void => {}).dependsOn(
	dependencySkippedPrereq,
);

const dependencyTodoPrereq =
	test.todo("dependency todo prereq", (_context: TestContext): void => {});

test("dependency todo dependent", (_context: TestContext): void => {}).dependsOn(
	dependencyTodoPrereq,
);
...
test("dependency unexpected pass dependent", (_context: TestContext): void => {}).dependsOn(
	dependencyUnexpectedPassPrereq,
);
