...
export class NegatedExpectation<T> {
	...
	toContain<Expected>(expected: Expected, message: string | null = null): void {
		assertCondition(
			!containsExpectedValue<T, Expected>(this.actual, expected, false),
			message,
		);
	}
	...
	toContainEqual<Expected>(
		...
		assertCondition(
			!containsExpectedValue<T, Expected>(this.actual, expected, true),
			message,
		);
	}
	...
	toBeGreaterThan(expected: T, message: string | null = null): void {
		assertCondition(
			!isGreaterThanExpectationValue(this.actual, expected),
			message,
		);
	}
	...
	toBeLessThan(expected: T, message: string | null = null): void {
		assertCondition(
			!isLessThanExpectationValue(this.actual, expected),
			message,
		);
	}
