...
`jest` adapter surface for `as-harness`, kept intentionally thin and synchronous.
...
It reuses the same Wasm runtime as `node:test` and `node:assert` and does not aim for full Jest parity.
...
need to satisfy the normal harness ABI documented in [003-2026-03-17-harness-abi.md](./003-2026-03-17-harness-abi.md).
...
- Harness ABI: [003-2026-03-17-harness-abi.md](./003-2026-03-17-harness-abi.md)
